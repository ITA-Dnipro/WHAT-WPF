...
{
    internal class BlackChecker : IChecker
    {
        private int _row;
        private int _column;
            ...
            get 
            {
                ...
                switch (_column)
                {
                    ...
                    case 7:
                        ...
                        break;
                    default:
                        if ((_row - 1 > -1 && _column + 1 < 8 && _board[_row - 1, _column + 1].Checker == null)
                            || (_row - 1 > -1 && _column - 1 > -1 && _board[_row - 1, _column - 1].Checker == null))
                        {
                            return true;
                        }
                        break;
        ...
        public BlackChecker(int row, int column, ICell[,] board) 
        {
